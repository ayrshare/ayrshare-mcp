...
- **Omitting `profileKey` reads the Business account, not the client.** To get a specific client's analytics, pass their `profileKey`. (Profile-scoped behavior — see `../getting-started/SKILL.md`.)

...
- **Posts** (`../ayrshare-mcp-posts/`): `create_post`, `validate_post`, `get_post`, `update_post`, `retry_post`.
- **History** (`../ayrshare-mcp-history/`): `get_post_history`, `get_platform_history`.
- **Analytics** (`../ayrshare-mcp-analytics/`): `get_post_analytics`, `get_post_analytics_by_social_id`, `get_social_network_analytics`.
- **Comments** (`../ayrshare-mcp-comments/`): `get_comments`, `add_comment`, `reply_comment`.
- **Messages / DMs** (`../ayrshare-mcp-messages/`): `get_messages`, `send_message`, `get_auto_response`, `set_auto_response`.
- **Profiles** (`../ayrshare-mcp-profiles/`): `list_profiles`, `create_profile`.
- **Media validation** (`../ayrshare-mcp-media/`): `validate_media`.
- **Generate** (`../ayrshare-mcp-generate/`): `generate_post`, `recommend_hashtags`.
- **Webhooks** (`../ayrshare-mcp-webhooks/`): `register_webhook`, `unregister_webhook`, `list_webhooks`.
- **Errors** (`../ayrshare-mcp-errors/`): `explain_error`.
